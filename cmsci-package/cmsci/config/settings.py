...
# Embedding cache — user-level so an installed package never writes into
# site-packages. Override with CMSCI_CACHE_DIR.
CACHE_DIR = Path(
    os.environ.get("CMSCI_CACHE_DIR", Path.home() / ".cache" / "cmsci")
) / "embeddings"
...
GEMINI_CACHE_DIR = CACHE_DIR.parent / "embeddings_gemini"
