...
class UnifiedPlannerLLM:
    name = "UnifiedPlannerOllama"

    def __init__(self, prompt_path: str = "src/planner/prompts/unified.txt"):
...
class UnifiedPlanner(UnifiedPlannerLLM):
    pass
